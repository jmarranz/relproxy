...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "relproxy_ex_gwt" because\n';
  ...
  $wnd.__gwt_activeModules['relproxy_ex_gwt'] = {
    'moduleName' : 'relproxy_ex_gwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/relproxy_ex_gwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['relproxy_ex_gwt'].superdevmode = true;

  var expectedSuffix = '/relproxy_ex_gwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + relproxy_ex_gwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:relproxy_ex_gwt';
  var devModeSessionKey = '__gwtDevModeSession:relproxy_ex_gwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/relproxy_ex_gwt/relproxy_ex_gwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['relproxy_ex_gwt'].canRedirect = true;
  $wnd.__gwt_activeModules['relproxy_ex_gwt'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING relproxy_ex_gwt';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/relproxy_ex_gwt?user.agent=' + ua + '&_callback=' + callback;
