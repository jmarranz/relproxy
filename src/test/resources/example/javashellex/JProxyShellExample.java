...
public class JProxyShellExample
{
    ...
    {
        System.out.println("JProxyShellExample execScriptEngine 1 ");  

        // Just to show that ScriptEngine is a JProxyScriptEngine object and is initialized, could be useful in a sort of "server" script, of course in this case provide a explicit positive scan period to detect source changes
