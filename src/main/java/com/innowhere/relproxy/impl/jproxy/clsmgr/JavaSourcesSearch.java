        ...
        for(String relPath : relPathList)
        {
            ...
            else
            {
                ...
                if (oldSourceFileMap != null)
                {
                    ...
                    {
                        sourceFile = ClassDescriptorSourceFile.create(ext,engine,className,file,timestampSourceFile);
...
//System.out.println("UPDATED: " + className + " " + urlClass.toExternalForm() + " " + (timestampSourceFile - timestampCompiledClass));
                        ...
                        else
                        {
                            ...
                            sourceFile = ClassDescriptorSourceFile.create(ext,engine,className,file,timestampCompiledClass);
